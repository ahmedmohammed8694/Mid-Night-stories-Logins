...
(function () {
  ...
  function createBookCard(book) {
    ...
    card.innerHTML = `
      <div class="book-card__cover-wrapper class-cover-trigger">
        <img class="book-card__cover" src="${book.cover_image_url || '/images/default-cover.svg'}" alt="${escapeHtml(book.title)} cover" loading="lazy" onerror="this.onerror=null; this.src='/images/default-cover.svg';">
  ...
  function openBookModal(book) {
    ...
    modalCover.src = book.cover_image_url || '/images/default-cover.svg';
